...
ode3 = x_velocity + lift_force(CL0,CLa,alpha(x_velocity,z_velocity),rho,r,velocity(x_velocity,y_velocity,z_velocity))*z_velocity...
...
ode4 = z_velocity + lift_force(CL0,CLa,alpha(x_velocity,z_velocity),rho,r,velocity(x_velocity,y_velocity,z_velocity))*x_velocity...
        /velocity(x_velocity,y_velocity,z_velocity) + ...
